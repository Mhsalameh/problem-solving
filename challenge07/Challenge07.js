...
const cvFormatter = (arr) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        if (arr[i].yearsOfExperience > 1) {
            result.push({
                fullName: (arr[i].lastName != null && arr[i].firstName != null) ? `${arr[i].firstName} ${arr[i].lastName}` : (arr[i].firstName == null) ? `${arr[i].lastName}` : `${arr[i].firstName}`,
                tech: `${arr[i].tech}`
            })
...
const applicationsStatics = (arr) => {
    ...
    for (let i = 0; i < arr.length; i++) {
        ...
        result.python_Devs = (arr[i].tech == "Python") ? result.python_Devs + 1 : result.python_Devs;
        result.javaScript_Devs = (arr[i].tech == "JS") ? result.javaScript_Devs + 1 : result.javaScript_Devs;
        result.dotNet_Devs = (arr[i].tech == ".Net") ? result.dotNet_Devs + 1 : result.dotNet_Devs;
        result.java_Devs = (arr[i].tech == "Java") ? result.java_Devs + 1 : result.java_Devs;
